...
4. Sinon : `git commit -m "chore: bootstrap project structure with starter-kit v0.6.0"`
...
- **Toujours** ajouter `<!-- generated-by: starter-kit v0.6.0 -->` en tête de chaque fichier généré (les templates le contiennent déjà).
